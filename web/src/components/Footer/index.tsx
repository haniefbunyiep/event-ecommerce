export default function Footer() {
  return (
    <footer className='divide-y border-t-2 border-secondary-foreground px-4 dark:bg-gray-100 dark:text-gray-800'>
          ...
          >
            <div className='flex h-12 w-12 items-center justify-center rounded-full dark:bg-violet-600'>
              <svg
                ...
                viewBox='0 0 32 32'
                fill='currentColor'
                className='h-5 w-5 flex-shrink-0 rounded-full dark:text-gray-50'
              >
                <path d='M18.266 26.068l7.839-7.854 4.469 4.479c1.859 1.859 1.859 4.875 0 6.734l-1.104 1.104c-1.859 1.865-4.875 1.865-6.734 0zM30.563 2.531l-1.109-1.104c-1.859-1.859-4.875-1.859-6.734 0l-6.719 6.734-6.734-6.734c-1.859-1.859-4.875-1.859-6.734 0l-1.104 1.104c-1.859 1.859-1.859 4.875 0 6.734l6.734 6.734-6.734 6.734c-1.859 1.859-1.859 4.875 0 6.734l1.104 1.104c1.859 1.859 4.875 1.859 6.734 0l21.307-21.307c1.859-1.859 1.859-4.875 0-6.734z'></path>
              </svg>
            </div>
            <span className='self-center text-2xl font-semibold'>Heptatix</span>
          </a>
        </div>
        <div className='grid grid-cols-2 gap-x-3 gap-y-8 text-sm sm:grid-cols-4 lg:w-2/3'>
          <div className='space-y-3'>
            <h3 className='uppercase tracking-wide dark:text-gray-900'>
              Product
            </h3>
